...
function displayCart() {
    ...
    for (var i in cartArray) {
        output += 
            ...
            ` <div class="cart-item">
                <div class="item-info">
                    <img src="image/${cartArray[i].imagesrc}" alt="">
                ...
                <div class="units">
                    <div class="btn minus" data-name="${cartArray[i].name}">-</div>
                    <div class="number" value="${cartArray[i].count}>1</div>
                    <div class="btn plus" data-name="${cartArray[i].name}">+</div>
                </div>
            </div>`
...
// Delete item button
//$(document).on('click', '.item-cancel .delete-item', function (event) {
